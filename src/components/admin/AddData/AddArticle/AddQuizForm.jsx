...
const AddQuizForm = ({ validationSchema, handleOpenModule, onSubmit, openModule, initialValues, title,isPost, }) => {

    // radio options for input-1
    const radioOptions1 = [
        { key: "", value: "mark_1" },
    ]
    // radio options for input-2
    const radioOptions2 = [
        { key: "", value: "mark_2" },
    ]
    // radio options for input-3
    const radioOptions3 = [
        { key: "", value: "mark_3" },
    ]
    // radio options for input-4
    const radioOptions4 = [
        { key: "", value: "mark_4" },
    ]
    return (
        <Module open={openModule} handleOpen={handleOpenModule} title={title} >
            <Formik onSubmit={onSubmit} initialValues={initialValues}  validationSchema={isPost ? validationSchema : null} >
                {formik => {
                    return (
                        <Form className='flex flex-col gap-6'>
                            <FormControl control={"input"} label={"Savol"} name={"question"} placeholder={"Savol kiriting"} />
                            <div className='grid grid-cols-2 gap-5'>
                                <div>
                                    <label className='text-sm' htmlFor="variant1">1-variant</label>
                                    <div className='flex items-center gap-2'>
                                        <FormControl control={"radio"} options={radioOptions1} label="" name="answer" />
                                        <FormControl control={"input"} label={""} name={"mark_1"} placeholder={"1-variant"} id={"variant1"} />
                                    </div>
                                </div>
                                <div>
                                    <label className='text-sm' htmlFor="variant2">2-variant</label>
                                    <div className='flex items-center gap-2'>
                                        <FormControl control={"radio"} options={radioOptions2} label="" name="answer" />
                                        <FormControl control={"input"} label={""} name={"mark_2"} placeholder={"2-variant"} id={"variant2"} />
                                    </div>
                                </div>
                                <div>
                                    <label className='text-sm' htmlFor="variant3">3-variant</label>
                                    <div className='flex items-center gap-2'>
                                        <FormControl control={"radio"} options={radioOptions3} label="" name="answer" />
                                        <FormControl control={"input"} label={""} name={"mark_3"} placeholder={"3-variant"} id={"variant3"} />
                                    </div>
                                </div>
                                <div>
                                    <label className='text-sm' htmlFor="variant4">4-variant</label>
                                    <div className='flex items-center gap-2'>
                                        <FormControl control={"radio"} options={radioOptions4} label="" name="answer" />
                                        <FormControl control={"input"} label={""} name={"mark_4"} placeholder={"4-variant"} id={"variant4"} />
                                    </div>
                                </div>
                            </div>
                            <div className='grid grid-cols-2 gap-5'>
                                <div>
                                    <FormControl control={"input"} label={"Ball"} name={"score"} placeholder={"Ballni kiriting"} />
                                </div>
                                <div>
                                    <FormControl control={"input"} label={"Vaqt/s"} name={"time"} placeholder={"Vaqtni kiriting"} />
                                </div>
                            </div>
                            <div>
                                <FormControl control={"textarea"} type="textarea" label="Izoh" name="option" />
                            </div>
